        ...
        return (
            React.createElement("nav", null, 
                React.createElement("ul", {className: "pagination"}, 
                    React.createElement(Page, {className: "page-item btn-first-page", 
                          key: "btn-first-page", 
                          isDisabled: this.isPrevDisabled(), 
                          onClick: this.handleFirstPage}, titles('first')), 

                    React.createElement(Page, {className: "page-item btn-prev-page", 
                          key: "btn-prev-page", 
                          isDisabled: this.isPrevDisabled(), 
                          onClick: this.handlePreviousPage}, titles('prev')), 

                    React.createElement(Page, {className: "page-item btn-prev-more", 
                          key: "btn-prev-more", 
                    ...
                    React.createElement(Page, {className: "page-item btn-next-more", 
                          key: "btn-next-more", 
                          isHidden: this.isNextMoreHidden(), 
                          onClick: this.handleMoreNextPages}, titles('nextSet')), 

                    React.createElement(Page, {className: "page-item btn-next-page", 
                          key: "btn-next-page", 
                          isDisabled: this.isNextDisabled(), 
                          onClick: this.handleNextPage}, titles('next')), 

                    React.createElement(Page, {className: "page-item btn-last-page", 
                          key: "btn-last-page", 
                          isDisabled: this.isNextDisabled(), 
    ...
    render: function () {
        ...
        return (
            React.createElement("li", {key: this.props.index, className: css}, 
                React.createElement("a", {className: "page-link", onClick: this.props.onClick}, this.props.children)
            )
        );
    }
});
